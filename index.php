...
<body>
    ...
    background-size: cover;
        ...
        <!-- Reservation Start -->
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Đặt sân</h5>
                        <h1 class="text-white mb-4">Mời điền thông tin</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
...
<div class="col-md-6">
    <div class="form-floating">
        ...
        <label for="endTime">Thời gian muốn thuê</label>
    </div>
</div>
<div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="select1">Chọn loại sân</label>
                                      </div>
                                </div>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.min.css" />
    ...
    $(document).ready(function () {
        ...
        $('#datetime').datepicker({
            format: 'dd/mm/yyyy', // Định dạng ngày tháng (có thể thay đổi)
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        flatpickr('#startTime', {
            ...
            dateFormat: "h:i K", // Định dạng giờ (24h)
            minTime: '7:00', // Giờ tối thiểu (7:00 AM)
            maxTime: '22:00'
        });
    });
</script>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        flatpickr('#endTime', {
            enableTime: true, // Cho phép chọn giờ
            noCalendar: true, // Không hiển thị lịch
            time_24hr: true, // Định dạng giờ theo 24h
            minTime: '0.5', // Thời gian tối thiểu là 0.5 giờ (30 phút)
            maxTime: '5', // Thời gian tối đa là 5 giờ
            increment: 30, // Bước nhảy là 30 phút
            defaultDate: '01:00'
        });
    });
</script>
